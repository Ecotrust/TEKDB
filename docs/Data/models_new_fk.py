...
class Citations(models.Model):
    citationid = models.ForeignKey(
        "Placescitationevents", db_column="CitationID", primary_key=True
...
class Locality(models.Model):
    ...
    placeid = models.ForeignKey(
        "Places", db_column="PlaceID", blank=True, null=True
    )  # Field name made lowercase.
...
class Localityplaceresourceevent(models.Model):
    placeresourceid = models.ForeignKey(
        "Placesresourceevents", db_column="PlaceResourceID"
    )  # Field name made lowercase.
    localityid = models.ForeignKey(
        Locality, db_column="LocalityID"
    )  # Field name made lowercase.
    enteredbyname = models.CharField(
        db_column="EnteredByName", max_length=25, blank=True, null=True
    )  # Field name made lowercase.
...
class Lookupauthortype(models.Model):
    authortype = models.CharField(
        db_column="AuthorType", unique=True, max_length=50
    )  # Field name made lowercase.
...
class Lookupuserinfo(models.Model):
    ...
    usingcustomusername = models.IntegerField(
...
class Mediacitationevents(models.Model):
    mediaid = models.ForeignKey(
        Media, db_column="MediaID"
    )  # Field name made lowercase.
    citationid = models.ForeignKey(
        Citations, db_column="CitationID"
    )  # Field name made lowercase.
...
class Placealtindigenousname(models.Model):
    altindigenousnameid = models.IntegerField(
...
class Placesresourceevents(models.Model):
    placeresourceid = models.IntegerField(
    ...
    barterresource = models.IntegerField(
...
class Resourceactivitycitationevents(models.Model):
    resourceactivityid = models.ForeignKey(
        "Resourcesactivityevents", db_column="ResourceActivityID"
    )  # Field name made lowercase.
    citationid = models.IntegerField(
        db_column="CitationID"
    )  # Field name made lowercase.
...
class Resourcesactivityevents(models.Model):
    resourceactivityid = models.IntegerField(
        db_column="ResourceActivityID", primary_key=True
    )  # Field name made lowercase.
    placeresourceid = models.ForeignKey(
        Placesresourceevents, db_column="PlaceResourceID", blank=True, null=True
    )  # Field name made lowercase.
...
class Resourcescitationevents(models.Model):
    resourceid = models.ForeignKey(
        Resources, db_column="ResourceID"
    )  # Field name made lowercase.
    citationid = models.ForeignKey(
        Citations, db_column="CitationID"
    )  # Field name made lowercase.
...
class Users(models.Model):
    ...
    username = models.CharField(
        db_column="UserName", max_length=20, blank=True, null=True
    )  # Field name made lowercase.
    ...
    affiliation = models.CharField(
        db_column="Affiliation", max_length=255, blank=True, null=True
    )  # Field name made lowercase.
    title = models.CharField(
        db_column="Title", max_length=255, blank=True, null=True
    )  # Field name made lowercase.
    accesslevel = models.IntegerField(
        db_column="AccessLevel", blank=True, null=True
    )  # Field name made lowercase.
