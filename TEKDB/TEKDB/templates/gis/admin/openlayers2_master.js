...
{% endfor %}{% endautoescape %}    };{% endblock %}
    ...
    {% endblock %} // geom_layer_interpretation
    {% endblock %} // geom_layer
    ...
    {% if mouse_position %}{{ module }}.map.addControl(new OpenLayers.Control.MousePosition({ displayProjection: 'EPSG:4326' }));{% endif %}
    {% if scale_text %}{{ module }}.map.addControl(new OpenLayers.Control.ScaleLine());{% endif %}
