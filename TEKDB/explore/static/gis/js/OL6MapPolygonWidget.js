...
// RDH 2022-04-29: ol.inherits no longer exists in OL6. Quick hack suggested by 'Mike': https://gis.stackexchange.com/a/324607/53225
...
// TODO: allow deleting individual features (#8972)
{
    ...
    MapWidget.prototype.createInteractions = function() {
        ...
        if (geomType === "Geometry" || geomType === "GeometryCollection") {
            // Default to Polygon, but create icons to switch type
            geomType = "Polygon";
            this.currentGeometryType = new GeometryTypeControl({widget: this, type: "Polygon", active: true});
            this.map.addControl(this.currentGeometryType);
            // this.map.addControl(new GeometryTypeControl({widget: this, type: "Point", active: false}));
