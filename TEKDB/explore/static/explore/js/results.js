function resultViewModel() {
  ...
  this.loadStateFromHash = function () {
    ...
    if (
      ...
      !isNaN($.query.get("items_per_page"))
    ) {
  ...
  this.setViewTiled = function () {
    ...
    window.location.hash = $.query.SET(
      "view",
      app.resultViewModel.state_view()
    );
  };
        ...
        result:
          ...
          '</h3>\
            ...
            <div class="row result-img-row">\
              <div class="col-md-12 col-sm-12 result-img-col ' +
          bg_class +
...
function resize_title_to_fit(self) {
  ...
  self
    .children()
    .first()
    .css("fontSize", parseFloat(fontsize) - 1);
