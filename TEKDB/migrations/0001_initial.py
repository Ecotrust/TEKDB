# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-06-02 05:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accesslevel', models.ForeignKey(db_column='AccessLevel', on_delete=django.db.models.deletion.CASCADE, to='TEKDB.UserAccess')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='resourceid',
            field=models.ForeignKey(blank=True, db_column='ResourceID', null=True, on_delete=django.db.models.deletion.CASCADE, to='TEKDB.Resources'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='mediaid',
            field=models.ForeignKey(db_column='MediaID', on_delete=django.db.models.deletion.CASCADE, to='TEKDB.Media'),
        ),
        migrations.AddField(
            model_name='resourceactivitycitationevents',
            name='citationid',
            field=models.ForeignKey(db_column='CitationID', on_delete=django.db.models.deletion.CASCADE, to='TEKDB.Citations'),
        ),
        migrations.AddField(
